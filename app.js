...
const MELODIES = [
  ...
  {id:'sweden', title:'Sweden', icon:'⛏️', desc:'Minecraft theme · C418', notes:[
    ['G4',1],['D5',1],['A4',1],['Cs5',1],['B4',1],['Fs5',1],['Cs5',1],['E5',2],
    ['B4',1],['Fs5',1],['Cs5',1],['E5',2],
    ['B4',.5],['A5',.5],['B5',1],['Fs5',1],['D5',1],['E5',2],
    ['Cs5',1],['Fs5',1],['A5',1],['E5',2]]},
  {id:'lava', title:'Lava Chicken', icon:'🍗', desc:'Minecraft Movie meme', notes:[
    ['D4',1.5],['D4',.5],['D4',.5],['D4',.5],['E4',.5],['D4',1],
    ['D4',.5],['D4',.5],['D4',.5],['E4',.5],['D4',1],['E4',.5],['G4',1.5]]},
  {id:'longago', title:'Long, Long Ago', icon:'🎻', desc:'folk classic · Suzuki Bk 2', notes:[
    ['D4',1],['D4',.5],['E4',.5],['Fs4',1],['Fs4',.5],['G4',.5],['A4',1],['B4',.5],['A4',.5],['Fs4',2],
    ['A4',1],['G4',.5],['Fs4',.5],['E4',2],['G4',1],['Fs4',.5],['E4',.5],['D4',2],
    ['D4',1],['D4',.5],['E4',.5],['Fs4',1],['Fs4',.5],['G4',.5],['A4',1],['B4',.5],['A4',.5],['Fs4',2],
    ['A4',1],['G4',.5],['Fs4',.5],['E4',1],['Fs4',.5],['E4',.5],['D4',2]]},
  ...
  {id:'starwars', title:'Star Wars Main Theme', icon:'🚀', desc:'the iconic fanfare · simplified', notes:[
    ...
    ['Cs5',1],['D5',1],['E5',3],
    ['D5',1],['Cs5',1],['B4',4]]},
  {id:'scarborough', title:'Scarborough Fair', icon:'🏰', desc:'traditional English ballad', notes:[
    ['E5',1],['E5',1],['B4',1],['B4',2],['Fs5',1],['G5',1],['Fs5',1],['E5',3],
    ['B4',1],['D5',1],['E5',1],['D5',1],['B4',1],['Cs5',1],['A4',1],['B4',3],
    ['E5',1],['E5',1],['E5',1],['D5',1],['B4',1],['B4',1],['A4',1],['G4',1],['Fs5',2],
    ['E5',1],['B4',1],['A4',1],['G4',1],['Fs5',1],['E5',1],['D5',1],['E5',3]]},
  {id:'etude-d', title:'Etude in D', icon:'🎻', desc:'original · Kayser-style study', notes:[
    ['D4',1],['E4',1],['Fs4',1],['G4',1],['A4',1],['B4',1],['Cs5',1],['D5',2],
    ['E5',1],['D5',1],['Cs5',1],['B4',1],['A4',1],['G4',1],['Fs4',1],['E4',2],
    ['D4',1],['Fs4',1],['A4',1],['D5',1],['Cs5',1],['A4',1],['Fs4',1],['D4',2],
    ['G4',1],['B4',1],['D5',1],['G5',1],['Fs5',1],['D5',1],['B4',1],['G4',2],
    ['A4',1],['Cs5',1],['E5',1],['A5',1],['G5',1],['E5',1],['Cs5',1],['A4',3]]},
  {id:'bouncy-bot', title:'Bouncy Bot', icon:'🤖', desc:'original · meme-ish bounce', notes:[
    ['D5',1],['D5',1],['A4',1],['B4',1],['Cs5',1],['D5',2],
    ['E5',1],['D5',1],['Cs5',1],['B4',1],['A4',1],['G4',1],['Fs4',2],['E4',1],
    ['D4',1],['E4',1],['Fs4',1],['G4',1],['A4',1],['B4',1],['D5',3]]},
];
